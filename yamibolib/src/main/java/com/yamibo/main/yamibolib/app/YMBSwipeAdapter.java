...
/**
 * Created by WINFIELD on 2015/11/24.
 */
public class YMBSwipeAdapter extends BaseSwipeAdapter {

    // utils
    protected static final String TAG = YMBSwipeAdapter.class.getSimpleName();
    ...
    */
    ...
    public YMBSwipeAdapter(Context mContext){
