...
public interface StatisticsService {
    public static final String ACTION_UPLOAD_SUCCESS = "com.yamibo.action.STAT_UPLOAD_SUCCESS";
     ...
     *
     * @param url    当前请求API的url。包括GET和POST
     * @param extras 额外信息，如network, elapse, tag, statusCode等。可以为null
     */
     ...
     *
     * @param category 分类，按主要页面即业务分，如index代表主页
     * @param action   动作，一般命名规则为category_actionName，如index_search
     * @param label    可阅读的标签，如名字等。一般是离散的值，用于统计出现频率
     * @param value    非离散值，用于统计平均值。如列表点击位置，消费价格等
     * @param extras   额外信息，如request_id。可以为null
     */
